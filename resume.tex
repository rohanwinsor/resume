...
\section{Experience}
  ...
  \resumeSubheading
    {Senior Research Engineer - Machine Learning}{April 2024 -- Present}
    {Amazon}{Banglore, IN}
    \resumeItemListStart
        \resumeItem{Tested the efficacy of claud on backfilling product attributes}
        \resumeItem{Used Hierarchy Prompting to leverage internal LLMs to backfill attributes for products across amazon market places}
  \resumeItemListEnd
