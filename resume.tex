...
\section{Technical Skills}
 \begin{itemize}
    \small{\item{
     \textbf{Languages}{: Python, JavaScript, SQL, Go, C++} \\
     \textbf{Technologies/Frameworks}{: Linux, GitHub, PyTorch, TensorFlow, Docker, Flask, FastAPI, AWS, Redis, Celery, scikit-learn} \\
    }}
 \end{itemize}
 \vspace{-16pt}
